...
public class Main {
	...
	public static void main(String[] args) {
		// Starts the server
        Application.run(new App_http_websocket.Builder()
        	// Setups the server
            .setApp_http_websocketConfiguration(
				App_http_websocketConfigurationLoader.load(configuration -> configuration
