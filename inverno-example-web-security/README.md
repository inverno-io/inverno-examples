...
HTTP Basic authentication is showed at http://127.0.0.1:8080/basic/hello :

<img src="src/img/basic_auth.png" style="display: block; margin: 2em auto;"/>

<img src="src/img/basic_hello.png" style="display: block; margin: 2em auto;"/>
...
HTTP Digest authentication is showed at http://127.0.0.1:8080/digest/hello:

<img src="src/img/digest_auth.png" style="display: block; margin: 2em auto;"/>

<img src="src/img/digest_hello.png" style="display: block; margin: 2em auto;"/>

### Form login

Form authentication is showed at http://127.0.0.1:8080/form/hello:

<img src="src/img/form_login.png" style="display: block; margin: 2em auto;"/>

<img src="src/img/form_hello.png" style="display: block; margin: 2em auto;"/>
...
LDAP authentication is showed at http://127.0.0.1:8080/ldap/hello:

<img src="src/img/ldap_form_login.png" style="display: block; margin: 2em auto;"/>

<img src="src/img/ldap_hello.png" style="display: block; margin: 2em auto;"/>
...
<img src="src/img/ldap_identity.png" style="display: block; margin: 2em auto;"/>
...
<img src="src/img/ldap_read.png" style="display: block; margin: 2em auto;"/>

<img src="src/img/ldap_write.png" style="display: block; margin: 2em auto;"/>

However user `jdoe` which is not a writer can not access http://127.0.0.1:8080/ldap/write:

<img src="src/img/ldap_write_403.png" style="display: block; margin: 2em auto;"/>
...
The previous command should create archive `target/inverno-example-web-security-1.0.0-SNAPSHOT-application_linux_amd64.zip` containing the application and the Java runtime to run it:

```plaintext
$ unzip inverno-example-web-security-1.0.0-SNAPSHOT-application_linux_amd64.zip
$ ./inverno-example-web-security-1.0.0-SNAPSHOT/bin/example-web-security
...
```
...
The previous command should create archive `target/inverno-example-web-security-1.0.0-SNAPSHOT-container_linux_amd64.tar` docker image that can be loaded into docker as follows:
