...
public class AppWebController {
	...
	public Mono<Integer> getCounter(SessionContext<? extends AppSessionData, ? extends Session<? extends AppSessionData>> sessionContext) {
	...
	public Mono<Integer> incrementCounter(SessionContext<? extends AppSessionData, ? extends Session<? extends AppSessionData>> sessionContext) {
		return sessionContext.getSessionData()
