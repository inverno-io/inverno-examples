 ...
 */
@Wrapper @Bean
public class AppSessionStore implements Supplier<JWTSessionStore<AppSessionData, Map<String, String>>> {
	...
	@Override
	public JWTSessionStore<AppSessionData, Map<String, String>> get() {
		JWTSessionIdGenerator<AppSessionData, Map<String, String>> sessionIdGenerator;
		if(this.configuration.useJWE()) {
